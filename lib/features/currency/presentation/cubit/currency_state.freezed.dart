...
mixin _$CurrencyState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(double totalSpent) loaded,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(double totalSpent)? loaded,
...
class _$LoadedImpl implements _Loaded {
  const _$LoadedImpl({required this.totalSpent});
  ...
  @override
  String toString() {
    return 'CurrencyState.loaded(totalSpent: $totalSpent)';
  }
...
abstract class _Loaded implements CurrencyState {
  const factory _Loaded({required final double totalSpent}) = _$LoadedImpl;
